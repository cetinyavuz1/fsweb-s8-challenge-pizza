    ...
    <footer className="footer-section">
      <div className="footer-first">
        <address className="address-section">
          <img className="footer-logo" src="/assets/iteration-2/footer/logo-footer.svg" />
          <div className="ilk-satir">
            <img className="icon-image" src="/assets/iteration-2/footer/icons/icon-1.png" />
            <p>341 Londonderry Road,<br />Istanbul Türkiye</p>
          </div>
          <div className="ikinci-satir">
            <img className="icon-image" src="/assets/iteration-2/footer/icons/icon-2.png" />
            <p>aciktim@teknolojikyemekler.com</p>
          </div>
          <div className="ucuncu-satir">
            <img className="icon-image" src="/assets/iteration-2/footer/icons/icon-3.png" />
